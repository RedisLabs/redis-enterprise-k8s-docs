...
https://redis.io/docs/latest/operate/kubernetes/reference/api/redis_enterprise_database_api/

The authoritative field definitions also live in the CRD itself — run
`kubectl explain RedisEnterpriseDatabase` or see the [CRD schema](crds/).
