...
| --- | --- | --- |
| Redis Enterprise | `redislabs/redis:6.2.12-68` | `redislabs/redis:6.2.12-68.rhel8-openshift`, or `redislabs/redis:6.2.12-68.rhel7-openshift` (if upgrading from a RHEL7 cluster) |
| Operator | `redislabs/operator:6.2.16-5` | `redislabs/operator:6.2.16-5` |
| Services Rigger | `redislabs/k8s-controller:6.2.16-5` | `redislabs/k8s-controller:6.2.16-5` |
    ...
    spec:
      containers:
        - name: redis-enterprise-operator
          image: harbor.corp.local/redisenterprise/operator:6.2.16-5
```
...
```yaml
  RedisEnterpriseImageSpec:
    versionTag: redislabs/redis:6.2.12-68
```
...
|----------------------|------------------|--------------------------------|
| `redislabs/operator:6.2.16-5` | `redislabs/redis:6.2.12-68`   | `redislabs/redis:6.2.12-68.rhel8-openshift` |
