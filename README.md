...
| Operator | `redislabs/operator:6.2.10-1` | `redislabs/operator:6.2.10-1` |
| Services Rigger | `redislabs/k8s-controller:6.2.10-1` | `redislabs/k8s-controller:6.2.10-1` |
    ...
    spec:
      containers:
        - name: redis-enterprise-operator
          image: harbor.corp.local/redisenterprise/operator:6.2.10-1
```
