...
| Operator | `redislabs/operator:6.2.8-10` | `redislabs/operator:6.2.8-10` |
| Services Rigger | `redislabs/k8s-controller:6.2.8-10` | `redislabs/k8s-controller:6.2.8-10` |
    ...
    spec:
      containers:
        - name: redis-enterprise-operator
          image: harbor.corp.local/redisenterprise/operator:6.2.8-10
```
