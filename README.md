...
| Operator | `redislabs/operator:100.0.5-6087` | `redislabs/operator:100.0.5-6087` |
| Services Rigger | `redislabs/k8s-controller:100.0.5-6087` | `redislabs/k8s-controller:100.0.5-6087` |
    ...
    spec:
      containers:
        - name: redis-enterprise-operator
          image: harbor.corp.local/redisenterprise/operator:100.0.5-6087
```
