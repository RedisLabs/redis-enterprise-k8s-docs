...
| --- | --- | --- |
| Redis Enterprise | `redislabs/redis:6.2.10-100` | `redislabs/redis:6.2.10-100.rhel8-openshift` |
| Operator | `redislabs/operator:6.2.10-31` | `redislabs/operator:6.2.10-31` |
| Services Rigger | `redislabs/k8s-controller:6.2.10-31` | `redislabs/k8s-controller:6.2.10-31` |
    ...
    spec:
      containers:
        - name: redis-enterprise-operator
          image: harbor.corp.local/redisenterprise/operator:6.2.10-31
```
...
```yaml
  RedisEnterpriseImageSpec:
    versionTag: redislabs/redis:6.2.10-100
```
