...
| --- | --- | --- |
| Redis Enterprise | `redislabs/redis:6.2.12-31` | `redislabs/redis:6.2.12-31.rhel8-openshift` |
| Operator | `redislabs/operator:100.0.2-556` | `redislabs/operator:100.0.2-556` |
| Services Rigger | `redislabs/k8s-controller:100.0.2-556` | `redislabs/k8s-controller:100.0.2-556` |
    ...
    spec:
      containers:
        - name: redis-enterprise-operator
          image: harbor.corp.local/redisenterprise/operator:100.0.2-556
```
...
```yaml
  RedisEnterpriseImageSpec:
    versionTag: redislabs/redis:6.2.12-31
```
